 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LCTL, KC_LALT, KC_LGUI, KC_LOWER,  DICTATE,     KC_SPC, KC_LEFT , KC_DOWN, KC_UP, KC_RGHT
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_LOWER] = LAYOUT(
  //,------------------------------------------------.                    ,---------------------------------------------------.
  KC_DEL,  KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,                     MS_LEFT,      MS_DOWN,      MS_UP,      MS_RGHT,      KC_F10,  MS_BTN1,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
